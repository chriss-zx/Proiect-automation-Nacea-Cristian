...
public class AddNewContact extends BaseTest {
    ...
    // se face login-ul, se verifica ca mesajul de eroare sa nu fie afisat si se redirectioneaza catre homepage, dupa care se verifica ca pagina sa fie cea corecta.
    // dupa redirectionarea pe homepage, se apasa butonul de "Add a New Contact", se verifica ca pagina sa fie cea corecta si se introduc datele VALIDE, dupa care se apasa butonul submit, se verifica ca pagina sa fie cea corecta si apoi [...]
    // [...] se verifica daca contactul a fost adaugat.
    ...
    // se face login-ul, se verifica ca mesajul de eroare sa nu fie afisat si se redirectioneaza catre homepage, dupa care se verifica ca pagina sa fie cea corecta.
    // dupa redirectionarea pe homepage, se apasa butonul de "Add a New Contact", se verifica ca pagina sa fie cea corecta si se introduc datele INVALIDE, dupa care se apasa butonul submit, se asteapta ca mesajul de eroare sa apara [...]
    // [...] si apoi se verifica daca mesajul de eroare este afisat.
